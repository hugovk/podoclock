...
#ifndef __PODOCLOCKUIDS_H__
#define __PODOCLOCKUIDS_H__

// const TUid KUidOviSigned  = {0x200427FA};
// const TUid KUidSelfSigned = {0xA89FB98E};
#define KUidOviSigned 0x200427FA
#define KUidSelfSigned 0xA89FB98E

#endif // __PODOCLOCKUIDS_H__
